...
const CONFIG = {
  ...
  soundThresholds: {
    QUIET:          _saved.soundThresholds?.QUIET          ?? 70,
    LIGHT_ACTIVITY: _saved.soundThresholds?.LIGHT_ACTIVITY ?? 110,
    RESTLESS:       _saved.soundThresholds?.RESTLESS       ?? 250,
    CRYING:         _saved.soundThresholds?.CRYING         ?? 400,
  },
  sensitivityRange: {
    min: 1,
    max: 20,
